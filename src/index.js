  ...
  return (
    <main className="menu">
      ...
      {numPizzas > 0 ? (
        <>
          <p>
            Authentic Italian Cuisine. 6 creative dishes to choose from. All from our stone ove, all organic, all delicious.
          </p>
          <ul className="pizzas">
            {pizzas.map((pizza) => (
      ...
      {/*<Pizza
        ...
        photoName="pizzas/spinaci.jpg" // Corretto da photo a photoName
        price={10}
      />
      <Pizza
        name="Pizza Funghi"
...
function Footer() {
  ...
  //if (!isOpen) return (<p>We'are happy to welcome you between {openHour}:00 and {closeHour}:00</p>);
